...
\begin{frame}{Propsed Method}
  \begin{itemize}
    \item Assume $x, y$ and $r_1$ are indepent, and derive the non-linear
          equations into linear ones, and linear \emph{Least Squares} (LS) problem
    ...
    \item Incorporate the dependent relationship back in to get more accurate
          solution.
  \end{itemize}
